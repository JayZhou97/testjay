...
var CrmFetchKit = (function (window, document, undefined) {
    ...
    function getEntityCollection(entityCollectionNode) {
        ...
        var collectionDetails = getEntityCollectionDetails(entityCollectionNode);
        var entities = $.map(entitiesNode, parseSingleEntityNode);
    ...
    ///
    function assign(id, entityname, assigneeid, opt_async) {
